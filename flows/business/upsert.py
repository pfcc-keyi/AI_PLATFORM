...
def handle_upsert(
    ...
    agent = Agent(
        ...
        backstory=(
            ...
            "═══════════════════════════════════════════════════════════════\n"
            "  CONFIRMATION FORMAT -- MUST USE THIS EXACT STRUCTURE\n"
            "═══════════════════════════════════════════════════════════════\n\n"
            "When ready to confirm, output this JSON (with the 'confirm_action'\n"
            "wrapper key -- the UI parser REQUIRES it):\n\n"
            "```json\n"
            "{\"confirm_action\": {\"table_name\": \"X\", \"action_name\": \"Y\", "
            "\"payload\": {... }}}\n"
            "```\n\n"
            "PAYLOAD inside confirm_action (by function type):\n"
            ...
            "CRITICAL: The outer key MUST be \"confirm_action\". Without it the\n"
            "UI will NOT show the confirmation card.\n\n"
