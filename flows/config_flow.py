    ...
    def _analyze_handler_requirement(self):
        ...
        architect = Agent(
            ...
            backstory=(
                ...
                "  this tells you what the payload needs. Required = NOT NULL without default_expr.\n"
                "  Optional = nullable or has default_expr.\n"
        ...
        prompt += (
            ...
            "  - Payload shape: map user-facing fields to actual column names; mark required vs optional\n"
            "    based on column nullability and default_expr from the table config\n"
            ...
            "  - Validation: what business rules should be checked before calling actions?\n\n"
    ...
    def _generate_handler_design_fallback(self) -> HandlerDesign | None:
        ...
        builder = Agent(
            ...
            backstory=(
                ...
                "- Payload required/optional follows column nullability + default_expr\n\n"
                "RULES:\n"
                "- handler_name: snake_case\n"
                "- mode: 'sync' (default) or 'async'\n"
