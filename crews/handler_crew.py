    ...
    def crew(
        ...
        generator = Agent(
            ...
            backstory=(
                ...
                "- Column definitions: pg_type, nullable, constraints — tells you what fields each action needs\n"
        ...
        task = Task(
            description=(
                ...
                "16. Return a dict combining action results, extracted IDs, counts, or mapped fields as needed\n"
                "17. Data mapping is the core pattern: each field or argument comes from payload,\n"
                "    previous action results, or generated values (only when needed, e.g. timestamps)\n"
                "18. Read table configs via dp_file_read to discover available actions and select the\n"
